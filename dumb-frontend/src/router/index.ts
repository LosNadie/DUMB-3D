...
import AnimeListView from '../views/NewsView.vue'
import AnimeDetailView from '../views/NewsDetailView.vue'
import MovieListView from '../views/InterviewsView.vue'
import MovieDetailView from '../views/InterviewDetailView.vue'
